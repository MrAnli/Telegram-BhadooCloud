module.exports = Object.freeze({
  TOKEN: '1146290375:AAGmH0cnlpHxBrKhUulGb3UU4mNVBvLxtHY', //Token Telegram Bots
  ...
  GDRIVE_PARENT_DIR_ID:  '1m5vgC6TnpnXAP4F6NPdSiCRyJM5hpOvT', // for directorty eg. https://drive.google.com/drive/folders/1p7pHhSh2yboWePmo53DnVr3xkAYiojP9 use 1p7pHhSh2yboWePmo53DnVr3xkAYiojP9
  SUDO_USERS: [1182495204],	// Telegram user IDs. These users can use the bot in any chat. required, get it using https://t.me/YourTGid_Bot
  AUTHORIZED_CHATS: [-1182495204],	// Telegram chat IDs. Anyone in these chats can use the bot. Add https://t.me/YourTGid_Bot to Group and click /id
  ...
  DOWNLOAD_NOTIFY_TARGET: {  // Information about the web service to notify on download completion. not required
    ...
    COMMANDS_USE_BOT_NAME: {
      ...
      NAME: "@TukangUpload_Bot" //Enter your Bot Username here if above is set to true.
    }
});
